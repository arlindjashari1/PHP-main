...
$posts = fetchAll($pdo, "SELECT p.*, c.name AS category_name
  FROM posts p LEFT JOIN categories c ON c.id = p.category_id
  {$where} ORDER BY p.id DESC LIMIT 12", $params);
?>
<div class="row mb-3">
  <div class="col-md-8">
    <h4>Slider</h4>
...
<?php else: foreach($posts as $p): ?>
  <div class="border rounded p-3 mb-3">
    ...
    <a class="btn btn-sm btn-outline-primary" href="/php_mysql_media_starter/public/post.php?id=<?= (int)$p['id'] ?>">Lexo më shumë</a>
  </div>
